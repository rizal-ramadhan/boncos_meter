...
class AllExpenseScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: const CommonToolbar(currentScreen: 'All Expense'),
      body: Consumer<TransactionProvider>(
        builder: (context, transactionProvider, child) {
          // Use filteredTransactions instead of expenseTransactions
          ...
          return Stack(
            children: [
              ...
              expenseTransactions.isEmpty
                  ? _EmptyExpenseState(hasActiveSearch: hasActiveSearch)
                  : Padding(
...
class _EmptyExpenseState extends StatelessWidget {
  ...
  const _EmptyExpenseState({this.hasActiveSearch = false});
  ...
  Widget build(BuildContext context) {
    ...
    final iconColor = AppColors.expense.withValues(alpha: 0.7);
          ...
          child: Column(
            ...
            children: [
              Container(
                ...
                child: Icon(
                  hasActiveSearch ? Icons.search_off : Icons.north_east,
                  size: 48,
              ...
              Text(
                hasActiveSearch
                    ? 'Try adjusting your search terms or clear the search to see all expense transactions'
              ...
              ElevatedButton.icon(
                ...
                label: Text(hasActiveSearch ? 'Clear Search' : 'Add Expense'),
                style: ElevatedButton.styleFrom(
                  backgroundColor: hasActiveSearch ? Colors.orange : AppColors.expense,
